...
function buildDocumentXml(paragraphs: DocParagraph[], docTitle: string): string {
  ...
  <w:r><w:rPr><w:b/><w:color w:val="${D.white}"/><w:sz w:val="32"/><w:rFonts w:ascii="Calibri Light" w:hAnsi="Calibri Light"/></w:rPr><w:t xml:space="preserve"> &#x2726; BLINGA EXPORT</w:t></w:r>
</w:p>
<w:p>
  ...
  <w:r><w:rPr><w:color w:val="${D.muted}"/><w:sz w:val="16"/></w:rPr><w:t>Generated by Blinga</w:t></w:r>
...
export async function downloadWordDoc(content: string, filename = 'blinga-document') {
  // Step 1 — AI reformat
