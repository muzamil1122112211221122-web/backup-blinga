...
export async function downloadPptx(content: string, filename = 'blinga-presentation') {
  ...
  const theme = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><a:theme xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" name="Blinga"><a:themeElements><a:clrScheme name="Blinga"><a:dk1><a:srgbClr val="${C.darkTxt}"/></a:dk1><a:lt1><a:srgbClr val="${C.white}"/></a:lt1><a:dk2><a:srgbClr val="${C.navy}"/></a:dk2><a:lt2><a:srgbClr val="${C.offWht}"/></a:lt2><a:accent1><a:srgbClr val="${C.indigo}"/></a:accent1><a:accent2><a:srgbClr val="${C.purple}"/></a:accent2><a:accent3><a:srgbClr val="${C.cyan}"/></a:accent3><a:accent4><a:srgbClr val="${C.emerald}"/></a:accent4><a:accent5><a:srgbClr val="${C.amber}"/></a:accent5><a:accent6><a:srgbClr val="${C.rose}"/></a:accent6><a:hlink><a:srgbClr val="${C.indigo}"/></a:hlink><a:folHlink><a:srgbClr val="${C.purple}"/></a:folHlink></a:clrScheme><a:fontScheme name="Blinga"><a:majorFont><a:latin typeface="Calibri Light"/><a:ea typeface=""/><a:cs typeface=""/></a:majorFont><a:minorFont><a:latin typeface="Calibri"/><a:ea typeface=""/><a:cs typeface=""/></a:minorFont></a:fontScheme><a:fmtScheme name="Blinga"><a:fillStyleLst><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:solidFill><a:schemeClr val="phClr"/></a:solidFill></a:fillStyleLst><a:lnStyleLst><a:ln w="6350"><a:solidFill><a:schemeClr val="phClr"/></a:solidFill></a:ln><a:ln w="12700"><a:solidFill><a:schemeClr val="phClr"/></a:solidFill></a:ln><a:ln w="19050"><a:solidFill><a:schemeClr val="phClr"/></a:solidFill></a:ln></a:lnStyleLst><a:effectStyleLst><a:effectStyle><a:effectLst/></a:effectStyle><a:effectStyle><a:effectLst/></a:effectStyle><a:effectStyle><a:effectLst/></a:effectStyle></a:effectStyleLst><a:bgFillStyleLst><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:solidFill><a:schemeClr val="phClr"/></a:solidFill></a:bgFillStyleLst></a:fmtScheme></a:themeElements></a:theme>`;
