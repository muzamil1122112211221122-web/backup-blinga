        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex justify-center">
            <Button 
              onClick={handleGetStarted}
              size="lg"
              className={`bg-gradient-to-r from-white via-gray-400 to-gray-700 text-gray-900 px-16 py-8 text-2xl rounded-full flex items-center justify-center space-x-4 will-change-transform hero-btn ${isNavigating ? 'animate-pop-out' : 'hover:scale-110 transition-transform duration-100'}`}
