  ...
  return (
    <div className="min-h-screen relative bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <div className="fixed top-5 left-0 right-0 z-50 flex justify-center px-6">
        <header className="flex items-center justify-between bg-gradient-to-r from-gray-700 via-gray-800 to-gray-500 backdrop-blur-lg rounded-full px-8 py-3 shadow-2xl w-full max-w-5xl">
