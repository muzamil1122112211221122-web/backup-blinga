...
const WORD_LIST = [
  ...
  { word: 'CINEMA', hint: 'Place where movies are shown' },
  { word: 'WIZARD', hint: 'Magical spellcaster' },
  { word: 'CLOUDS', hint: 'Float in the sky and bring rain' },
  { word: 'PIRATE', hint: 'Sea thief with a ship' },
  { word: 'MARBLE', hint: 'Small glass ball used in games' },
  { word: 'BEACON', hint: 'Light signal to guide ships' },
  { word: 'FAMINE', hint: 'Extreme food shortage' },
  { word: 'GOBLIN', hint: 'Mischievous creature in folklore' },
  { word: 'HAMMER', hint: 'Tool for driving nails' },
  { word: 'ISLAND', hint: 'Land surrounded by water' },
  { word: 'JAGUAR', hint: 'Spotted big cat of the Americas' },
  { word: 'KESTREL', hint: 'Small hovering falcon' },
  { word: 'LANTERN', hint: 'Portable light in a case' },
  { word: 'MUFFIN', hint: 'Small baked cake, often blueberry' },
  { word: 'NEEDLE', hint: 'Used for sewing' },
  { word: 'ORANGE', hint: 'Citrus fruit, also a colour' },
  { word: 'PARROT', hint: 'Colourful bird that mimics speech' },
  { word: 'QUARTZ', hint: 'Common mineral in many rocks' },
  { word: 'RIDDLE', hint: 'A puzzling question' },
  { word: 'SADDLE', hint: 'Seat placed on a horse' },
  ...
  { word: 'ZIPPER', hint: 'Fastener on clothing or bags' },
  { word: 'ANCHOR', hint: 'Keeps a ship in place' },
  { word: 'BONSAI', hint: 'Miniature cultivated tree' },
  { word: 'COBALT', hint: 'Bright blue chemical element' },
  { word: 'DAGGER', hint: 'Short sharp blade weapon' },
  { word: 'ENIGMA', hint: 'A mystery or puzzle' },
  { word: 'FALCON', hint: 'Fast bird of prey' },
  { word: 'GRAVEL', hint: 'Small stones used on paths' },
  { word: 'HORNET', hint: 'Large aggressive wasp' },
];
