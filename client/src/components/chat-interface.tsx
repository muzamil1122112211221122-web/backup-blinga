...
const IMAGINE_PROMPTS_BY_STYLE: Record<string, {label: string; prompt: string; img: string}[]> = {
  ...
  "3D Render": [
    { label: "Neon Megacity",       prompt: "a futuristic neon-lit megacity at night with holographic billboards and flying cars",                 img: `https://image.pollinations.ai/prompt/${encodeURIComponent("futuristic neon megacity at night, towering skyscrapers with holographic billboards, flying cars, rain-slicked streets, ultra-realistic Unreal Engine 5 CGI render, cinematic lighting, 8K")}?width=600&height=400&nologo=true&seed=30001&model=flux` },
    { label: "Space Station",       prompt: "a sleek orbital space station with Earth glowing below, photorealistic CGI render",                   img: `https://image.pollinations.ai/prompt/${encodeURIComponent("sleek orbital space station floating above glowing Earth, photorealistic Blender Cycles 3D render, ray tracing reflections, studio HDRI lighting, 8K resolution")}?width=600&height=400&nologo=true&seed=30002&model=flux` },
    { label: "Chrome Robot",        prompt: "a detailed chrome humanoid robot in a neon-lit industrial facility, octane render",                   img: `https://image.pollinations.ai/prompt/${encodeURIComponent("detailed chrome humanoid robot standing in neon-lit industrial facility, subsurface scattering metallic skin, Octane render, dramatic side lighting, cinematic 3D CGI")}?width=600&height=400&nologo=true&seed=30003&model=flux` },
    { label: "Crystal Geometry",    prompt: "intricate glowing crystalline geometric structures floating in deep space void, blender render",      img: `https://image.pollinations.ai/prompt/${encodeURIComponent("intricate glowing crystalline geometric structures floating in deep space void, iridescent facets, Blender Cycles render, volumetric light beams, photorealistic")}?width=600&height=400&nologo=true&seed=30004&model=flux` },
    { label: "Underwater Base",     prompt: "a futuristic underwater research base with bioluminescent sea life, cinematic CGI render",            img: `https://image.pollinations.ai/prompt/${encodeURIComponent("futuristic underwater research base surrounded by glowing bioluminescent sea creatures, deep ocean blue light, cinematic Unreal Engine CGI render, photorealistic")}?width=600&height=400&nologo=true&seed=30005&model=flux` },
    { label: "Sci-Fi Corridor",     prompt: "a sleek sci-fi spaceship corridor with glowing panels and metallic reflections, unreal engine 5",    img: `https://image.pollinations.ai/prompt/${encodeURIComponent("sleek sci-fi spaceship interior corridor, glowing neon panel edges, polished metallic floor reflections, Unreal Engine 5 lumen GI, cinematic 3D render")}?width=600&height=400&nologo=true&seed=30006&model=flux` },
  ],
  "Watercolor": [
  ...
  "Pixel Art": [
    { label: "Retro City Night",    prompt: "a colorful 16-bit pixel art city skyline at night with neon signs and 8-bit cars on the streets",    img: `https://image.pollinations.ai/prompt/${encodeURIComponent("16-bit pixel art city skyline at night, neon signs glowing, 8-bit cars on rain streets, SNES retro game art, flat vibrant colors, pixel grid visible")}?width=600&height=400&nologo=true&seed=40001&model=flux` },
    { label: "Island Adventure",    prompt: "a tiny pixel art tropical island with palm trees, buried treasure, and a pirate ship offshore",       img: `https://image.pollinations.ai/prompt/${encodeURIComponent("pixel art tropical island adventure, palm trees treasure chest pirate ship offshore, 16-bit SNES retro game sprite, vibrant flat pixel colors")}?width=600&height=400&nologo=true&seed=40002&model=flux` },
    { label: "Space Shooter",       prompt: "a retro 8-bit pixel art space shooter game with starfields, enemy ships, and laser beams",           img: `https://image.pollinations.ai/prompt/${encodeURIComponent("8-bit retro pixel art space shooter game, starfield background, enemy pixel ships, laser beams, NES game style, pixelated flat colors")}?width=600&height=400&nologo=true&seed=40003&model=flux` },
    { label: "Dungeon Quest",       prompt: "a moody pixel art dungeon with flickering torches, treasure chests, and a pixelated hero",           img: `https://image.pollinations.ai/prompt/${encodeURIComponent("pixel art dungeon RPG scene, flickering torch light, stone walls, treasure chest, pixelated hero sprite, dark moody 16-bit retro game")}?width=600&height=400&nologo=true&seed=40004&model=flux` },
    { label: "Mushroom Village",    prompt: "a cozy pixel art forest village with colorful mushroom houses and tiny fairy lights at dusk",         img: `https://image.pollinations.ai/prompt/${encodeURIComponent("cozy pixel art forest village, colorful mushroom houses, tiny fairy lights at dusk, 16-bit SNES retro game art, flat vibrant colors")}?width=600&height=400&nologo=true&seed=40005&model=flux` },
    { label: "Dragon Castle",       prompt: "a 16-bit pixel art dragon perched on a towering castle with a stormy pixelated sky",                 img: `https://image.pollinations.ai/prompt/${encodeURIComponent("16-bit pixel art dragon on a towering medieval castle, stormy pixel sky lightning, retro RPG game scene, SNES era flat pixel colors")}?width=600&height=400&nologo=true&seed=40006&model=flux` },
  ],
  "Sketch": [
