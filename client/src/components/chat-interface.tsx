                  ...
                  'claude-3.5-sonnet': { 
                    ...
                    logo: (
                      <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-orange-400 to-red-600 flex items-center justify-center">
                        <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white">
                          <path d="M7.5 2A5.5 5.5 0 0 0 2 7.5v9A5.5 5.5 0 0 0 7.5 22h9a5.5 5.5 0 0 0 5.5-5.5v-9A5.5 5.5 0 0 0 16.5 2h-9ZM12 6.5a1 1 0 0 1 1 1v2a1 1 0 0 1-2 0v-2a1 1 0 0 1 1-1ZM7.5 12A4.5 4.5 0 0 1 12 7.5h0A4.5 4.5 0 0 1 16.5 12v4.5h-9V12Z"/>
                        </svg>
                      </div>
                    ), 
                  ...
                  'llama-3.3-70b-versatile': { 
                    ...
                    logo: (
                      <div className="w-8 h-8 rounded-full bg-gradient-to-r from-purple-500 to-pink-600 flex items-center justify-center">
                        <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white">
                          <path d="M12 2C10.9 2 10 2.9 10 4C10 5.1 10.9 6 12 6C13.1 6 14 5.1 14 4C14 2.9 13.1 2 12 2ZM21 9H15L13.5 7.5C13.1 7.1 12.6 6.9 12 6.9S10.9 7.1 10.5 7.5L9 9H3C1.9 9 1 9.9 1 11V19C1 20.1 1.9 21 3 21H21C22.1 21 23 20.1 23 19V11C23 9.9 22.1 9 21 9Z"/>
                        </svg>
                      </div>
                    ), 
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center space-x-2">
                          ...
                          {model === 'claude-3.5-sonnet' && (
                            <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-orange-400 to-red-600 flex items-center justify-center">
                              <svg viewBox="0 0 24 24" className="w-3 h-3 fill-white">
                                <path d="M7.5 2A5.5 5.5 0 0 0 2 7.5v9A5.5 5.5 0 0 0 7.5 22h9a5.5 5.5 0 0 0 5.5-5.5v-9A5.5 5.5 0 0 0 16.5 2h-9ZM12 6.5a1 1 0 0 1 1 1v2a1 1 0 0 1-2 0v-2a1 1 0 0 1 1-1ZM7.5 12A4.5 4.5 0 0 1 12 7.5h0A4.5 4.5 0 0 1 16.5 12v4.5h-9V12Z"/>
                              </svg>
                            </div>
