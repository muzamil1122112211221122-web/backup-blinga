          ...
          <div className="flex items-center justify-between px-2 pb-1.5">
            <div className="flex items-center">
              <Select value={selectedModel} onValueChange={(value: AvailableModel) => setSelectedModel(value)}>
                ...
                <SelectContent className="bg-white dark:bg-black !border-none !border-0 text-black dark:text-white rounded-xl shadow-2xl overflow-hidden ring-0 !ring-0 outline-none !outline-none focus:ring-0 !focus:ring-0 focus:outline-none !focus:outline-none focus-visible:ring-0 !focus-visible:ring-0 focus-visible:outline-none !focus-visible:outline-none">
