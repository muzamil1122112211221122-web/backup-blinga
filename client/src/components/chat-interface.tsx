...
const STUDIO_VISUAL_TEMPLATES = [
  ...
  { id: 'cozy-living-room',    category: 'Spaces',      name: 'Cozy Minimalist Living Room',     thumb: '/templates/thumb-0.jpg',  prompt: 'Vertical 9:16 interior design photo, a cozy minimalist living room with a low beige linen sofa, soft warm floor lamp lighting, large indoor monstera plant in a ceramic pot, neutral earth-toned walls, architectural digest style, 8k resolution.' },
  { id: 'luxury-bedroom',      category: 'Spaces',      name: 'Luxury Modern Bedroom',           thumb: '/templates/thumb-1.jpg',  prompt: 'Vertical 9:16 interior design photo, a luxurious modern bedroom featuring a plush king-size bed with dark grey velvet upholstery, warm recessed ceiling lights, chic bedside pendant lamps, large floor-to-ceiling glass window showing a city skyline at dusk.' },
  { id: 'aesthetic-workspace', category: 'Spaces',      name: 'Warm Aesthetic Workspace',        thumb: '/templates/thumb-2.jpg',  prompt: 'Vertical 9:16 interior design photo, a clean aesthetic home office desk setup with a wooden desktop, modern minimalist monitor, small warm desk lamp, neatly arranged stationery, a steaming ceramic mug, and soft natural sunlight casting shadows.' },
  { id: 'bohemian-loft',       category: 'Spaces',      name: 'Bohemian Loft Interior',          thumb: '/templates/thumb-3.jpg',  prompt: 'Vertical 9:16 interior design photo, a bright bohemian loft apartment with exposed brick walls, hanging wicker rattan chairs, vibrant woven rugs, lush trailing pothos plants, and warm golden hour light streaming through tall warehouse windows.' },
  { id: 'scandi-dining',       category: 'Spaces',      name: 'Scandi Dining Space',             thumb: '/templates/thumb-4.jpg',  prompt: 'Vertical 9:16 interior design photo, a Scandinavian dining room featuring a light oak wood dining table, minimalist black wire chairs, a sleek modern brass chandelier overhead, and a large abstract canvas painting on a white wall.' },
  { id: 'cyberpunk-gaming',    category: 'Spaces',      name: 'Cyberpunk Gaming Room',           thumb: '/templates/thumb-5.jpg',  prompt: 'Vertical 9:16 interior design photo, a futuristic high-tech gaming room illuminated by vibrant neon purple and cyan LED strip lights, dual curved monitor setup, acoustic wall panels, and a sleek ergonomic gaming chair.' },
  { id: 'japandi-living',      category: 'Spaces',      name: 'Japandi Living Area',             thumb: '/templates/thumb-6.jpg',  prompt: 'Vertical 9:16 interior design photo, a serene Japandi-style living area combining Japanese and Scandinavian design, low-profile light wood furniture, cream linen textures, minimalist ikebana flower vase on a low coffee table, soft diffused daylight.' },
  { id: 'industrial-cafe',     category: 'Spaces',      name: 'Industrial Coffee Shop Corner',   thumb: '/templates/thumb-7.jpg',  prompt: 'Vertical 9:16 interior design photo, a cozy corner inside an industrial-chic cafe featuring exposed concrete walls, leather tufted armchairs, black iron piping shelves with stacked books, and warm Edison bulb pendant lighting.' },
  { id: 'luxury-closet',       category: 'Spaces',      name: 'Luxury Walk-in Closet',           thumb: '/templates/thumb-8.jpg',  prompt: 'Vertical 9:16 interior design photo, a high-end luxury walk-in wardrobe with glass-front illuminated wooden clothing cabinets, neatly organized shelves, a central marble island display, and a modern geometric crystal chandelier.' },
  { id: 'zen-spa-bath',        category: 'Spaces',      name: 'Zen Spa Bathroom',                thumb: '/templates/thumb-9.jpg',  prompt: 'Vertical 9:16 interior design photo, a peaceful luxury spa bathroom with a freestanding stone bathtub, warm wooden slatted accent wall, soft glowing candles, folded white cotton towels, and smooth river stones under soft natural light.' },
  /* ── NATURE (10) — thumb-10 to thumb-19 ── */
  { id: 'mountain-peak',       category: 'Nature',      name: 'Majestic Mountain Peak',          thumb: '/templates/thumb-10.jpg', prompt: 'Vertical 9:16 landscape photography, a majestic snow-capped mountain peak towering over a calm alpine lake reflecting the crisp blue sky, dense pine forest lining the shore, dramatic cinematic nature view, 8k.' },
  { id: 'mystic-forest',       category: 'Nature',      name: 'Enchanted Mystic Forest',         thumb: '/templates/thumb-11.jpg', prompt: 'Vertical 9:16 landscape photography, an enchanted dense forest shrouded in morning mist, brilliant golden sunbeams piercing through tall ancient pine trees, soft green moss covering the damp forest floor, magical atmosphere.' },
  { id: 'tropical-waterfall',  category: 'Nature',      name: 'Tropical Paradise Waterfall',     thumb: '/templates/thumb-12.jpg', prompt: 'Vertical 9:16 landscape photography, a hidden crystal-clear tropical waterfall cascading into a turquoise jungle pool, lush vibrant green ferns and exotic tropical plants framing the scene, bright natural daylight.' },
  { id: 'golden-dunes',        category: 'Nature',      name: 'Golden Desert Dunes',             thumb: '/templates/thumb-13.jpg', prompt: 'Vertical 9:16 landscape photography, vast rolling sand dunes in a deep desert under a breathtaking sunset sky painted in gradients of orange, pink, and violet, wind-swept ripple textures on the sand, cinematic travel view.' },
  { id: 'ocean-sunset',        category: 'Nature',      name: 'Serene Ocean Sunset',             thumb: '/templates/thumb-14.jpg', prompt: 'Vertical 9:16 seascape photography, calm ocean waves gently kissing a pristine sandy shoreline at sunset, vibrant orange and purple hues reflecting on the wet sand, a single silhouette of a seabird flying in the distance.' },
  { id: 'lavender-valley',     category: 'Nature',      name: 'Lavender Valley Bloom',           thumb: '/templates/thumb-15.jpg', prompt: 'Vertical 9:16 landscape photography, endless rows of vibrant purple lavender fields in full bloom stretching towards rolling green hills under a bright summer sky with soft white clouds, warm afternoon sun.' },
  { id: 'autumn-stream',       category: 'Nature',      name: 'Autumn Woodland Stream',          thumb: '/templates/thumb-16.jpg', prompt: 'Vertical 9:16 landscape photography, a gentle crystal stream flowing over smooth mossy rocks through a forest filled with brilliant golden and red autumn foliage, fallen leaves floating on the water surface, crisp daylight.' },
  { id: 'milky-way-night',     category: 'Nature',      name: 'Starry Milky Way Night',          thumb: '/templates/thumb-17.jpg', prompt: 'Vertical 9:16 astrophotography, a breathtaking view of the glowing Milky Way galaxy arching over a dark silhouette of rugged mountain ranges, millions of sharp twinkling stars, deep space blues and purples.' },
  { id: 'glacial-ice-cave',    category: 'Nature',      name: 'Glacial Ice Cave',                thumb: '/templates/thumb-18.jpg', prompt: 'Vertical 9:16 nature photography, inside a breathtaking translucent blue glacial ice cave with intricate crystalline walls and natural light shining through the frozen arches, pristine sub-zero arctic environment.' },
  { id: 'cherry-blossom-path', category: 'Nature',      name: 'Blooming Cherry Blossom Path',   thumb: '/templates/thumb-19.jpg', prompt: 'Vertical 9:16 landscape photography, a peaceful stone path winding through a park lined with full-bloom pink cherry blossom trees, soft pastel petals gently falling on the ground, serene spring morning light.' },
  /* ── PORTRAITS (10) — thumb-20 to thumb-29 ── */
  { id: 'corporate-headshot',  category: 'Portraits',   name: 'Professional Corporate Headshot', thumb: '/templates/thumb-20.jpg', prompt: 'Vertical 9:16 studio portrait photo, a confident young professional man in a tailored navy blue suit and crisp white shirt, smiling slightly, clean blurred office background, soft studio lighting, sharp focus, 8k resolution.' },
  { id: 'high-fashion-look',   category: 'Portraits',   name: 'High Fashion Editorial Look',     thumb: '/templates/thumb-21.jpg', prompt: 'Vertical 9:16 high fashion portrait photo, a striking model wearing avant-garde haute couture attire with dramatic sculptural elements, bold artistic makeup, studio strobe lighting creating high contrast shadows, magazine cover style.' },
  { id: 'cinematic-portrait',  category: 'Portraits',   name: 'Cinematic Moody Portrait',        thumb: '/templates/thumb-22.jpg', prompt: 'Vertical 9:16 cinematic portrait photo, a young woman with expressive eyes looking out a rainy window at twilight, neon city lights reflecting on the glass, moody teal and orange color grading, dramatic depth of field.' },
  { id: 'golden-hour-portrait',category: 'Portraits',   name: 'Warm Golden Hour Portrait',       thumb: '/templates/thumb-23.jpg', prompt: 'Vertical 9:16 portrait photo, a cheerful young woman standing outdoors in a field of tall grass during golden hour, warm sunlight catching her blowing hair, soft bokeh background, natural and candid lifestyle photography.' },
  { id: 'minimalist-studio',   category: 'Portraits',   name: 'Minimalist Studio Portrait',      thumb: '/templates/thumb-24.jpg', prompt: 'Vertical 9:16 fine art portrait photo, a minimalist clean studio shot of a person with neutral-toned clothing, soft side-lit Rembrandt lighting, solid muted grey seamless paper background, sharp facial details, commercial grade.' },
  { id: 'cyberpunk-neon',      category: 'Portraits',   name: 'Cyberpunk Neon Portrait',         thumb: '/templates/thumb-25.jpg', prompt: 'Vertical 9:16 portrait photo, a person with futuristic cybernetic face accents illuminated by bright neon blue and pink lights in a dark rainy street alley, futuristic sci-fi aesthetic, highly detailed cyberpunk look.' },
  ...
  { id: 'scifi-corridor',      category: 'Fantasy',     name: 'Sci-Fi Space Station Corridor',   thumb: '/templates/thumb-32.jpg', prompt: 'Vertical 9:16 science fiction interior photo, a sleek white futuristic spacecraft corridor with glowing blue LED floor panels, large glass viewport showing deep space and distant nebulas, cinematic lighting.' },
  { id: 'dragon-hero',         category: 'Fantasy',     name: 'Mythical Dragon Hero',            thumb: '/templates/thumb-33.jpg', prompt: 'Vertical 9:16 fantasy character concept art, a fierce warrior clad in intricate dragon-scale armor standing triumphantly on a rocky cliff, a massive legendary dragon soaring through stormy skies in the background.' },
  { id: 'crystal-cave',        category: 'Fantasy',     name: 'Enchanted Crystal Cave',          thumb: '/templates/thumb-34.jpg', prompt: 'Vertical 9:16 fantasy digital illustration, a magical underground cavern filled with glowing purple and blue giant crystals, an underground subterranean river reflecting the luminescence, mystical and enchanting atmosphere.' },
  { id: 'steampunk-airship',   category: 'Fantasy',     name: 'Steampunk Airship Deck',          thumb: '/templates/thumb-35.jpg', prompt: 'Vertical 9:16 steampunk concept art, the wooden deck of a massive brass-trimmed airship flying above a sea of clouds at sunset, visible copper pipes, spinning gears, and a captain looking through an antique telescope.' },
  { id: 'overgrown-city',      category: 'Fantasy',     name: 'Post-Apocalyptic Overgrown City', thumb: '/templates/thumb-36.jpg', prompt: 'Vertical 9:16 cinematic digital art, a dystopian future city where nature has reclaimed abandoned skyscrapers, towering concrete buildings covered in thick green vines and trees, moody overcast atmosphere.' },
  { id: 'magic-portal',        category: 'Fantasy',     name: 'Magical Portal Gateway',          thumb: '/templates/thumb-37.jpg', prompt: 'Vertical 9:16 fantasy art, an ancient stone archway deep inside an ancient forest glowing with a swirling vortex of magical blue energy portal leading to another dimension, mystical lighting and soft fog.' },
  { id: 'atlantis-city',       category: 'Fantasy',     name: 'Underwater Lost Atlantis City',   thumb: '/templates/thumb-38.jpg', prompt: 'Vertical 9:16 fantasy digital art, a majestic lost underwater civilization with grand glowing marble columns, bioluminescent sea flora, schools of colorful tropical fish swimming through ancient submerged plazas.' },
  { id: 'star-goddess',        category: 'Fantasy',     name: 'Celestial Star Goddess',          thumb: '/templates/thumb-39.jpg', prompt: 'Vertical 9:16 high fantasy art, a divine celestial goddess draped in shimmering starlight garments, holding a glowing galaxy sphere in her hands, cosmic nebula background with swirling stardust and galaxies.' },
  /* ── FASHION (10) — thumb-40 to thumb-49 ── */
  { id: 'crimson-lehenga',     category: 'Fashion',     name: 'Royal Crimson Bridal Lehenga',    thumb: '/templates/thumb-40.jpg', prompt: 'Vertical 9:16 portrait photo, stunning South Asian bride wearing an intricate heavy crimson red velvet lehenga encrusted with gold Zardozi embroidery, matching sheer red dupatta draped over her head, traditional heavy gold polki jewelry, warm royal palace interior lighting with cinematic bridal photography, 8k.' },
  { id: 'indo-western-jacket', category: 'Fashion',     name: 'Contemporary Indo-Western Jacket',thumb: '/templates/thumb-41.jpg', prompt: 'Vertical 9:16 portrait photo, chic South Asian woman in a black tailored Indo-Western bandhgala jacket featuring intricate gold thread embroidery, dramatic side lighting casting soft shadows, minimalist background, high fashion editorial look, photorealistic texture.' },
  { id: 'silk-saree',          category: 'Fashion',     name: 'Classic Silk Saree Drape',        thumb: '/templates/thumb-42.jpg', prompt: 'Vertical 9:16 portrait photo, graceful woman wearing a rich teal and gold Banarasi silk saree, traditional gold jhumka earrings, soft heritage interior background with warm ambient light, elegant traditional posture, cinematic magazine style portrait.' },
  { id: 'ivory-sherwani',      category: 'Fashion',     name: 'Regal Ivory Sherwani',            thumb: '/templates/thumb-43.jpg', prompt: 'Vertical 9:16 portrait photo, handsome South Asian groom in an off-white silk sherwani with subtle gold embroidery and a matching pocket square, traditional carved heritage archway background, warm golden hour lighting, high-end ethnic menswear fashion shoot.' },
  { id: 'ethnic-fusion',       category: 'Fashion',     name: 'Modern Ethnic Fusion Ensemble',   thumb: '/templates/thumb-44.jpg', prompt: 'Vertical 9:16 portrait photo, elegant woman wearing a pastel cream silk crop top with an embroidered long jacket cape, soft natural window light filtering through tropical blinds, sophisticated traditional-modern fusion aesthetic, 8k resolution.' },
  { id: 'urban-streetwear',    category: 'Fashion',     name: 'Urban Luxury Streetwear',         thumb: '/templates/thumb-45.jpg', prompt: 'Vertical 9:16 portrait photo, stylish young man posing in an oversized charcoal grey technical parka jacket and matching relaxed cargo pants, futuristic urban neon-lit night backdrop, moody cinematic atmosphere, high-end streetwear fashion campaign.' },
  { id: 'linen-casual',        category: 'Fashion',     name: 'Minimalist Linen Casual Chic',    thumb: '/templates/thumb-46.jpg', prompt: 'Vertical 9:16 portrait photo, handsome man in a relaxed-fit beige linen button-down shirt and matching trousers, rustic earth-toned studio backdrop with raw stone texture, soft natural daylight, clean minimalist fashion editorial style.' },
  { id: 'athleisure-fit',      category: 'Fashion',     name: 'Athleisure Gym Fit',              thumb: '/templates/thumb-47.jpg', prompt: 'Vertical 9:16 portrait photo, fit athletic woman posing in an olive green sports bra and high-waisted leggings set, modern minimalist concrete gym studio with soft natural light, healthy lifestyle fitness fashion photography, crisp details.' },
  { id: 'emerald-gown',        category: 'Fashion',     name: 'Emerald Silk Evening Gown',       thumb: '/templates/thumb-48.jpg', prompt: 'Vertical 9:16 portrait photo, glamorous woman wearing a sleek deep emerald green satin evening gown with a wrap design, sitting on a dark velvet lounge chair, moody luxury cocktail lounge lighting, high-end red carpet fashion look.' },
  { id: 'resort-linen',        category: 'Fashion',     name: 'Resort Vacation Linen Style',     thumb: '/templates/thumb-49.jpg', prompt: 'Vertical 9:16 portrait photo, stylish man in a crisp white resort linen shirt left slightly open, tropical background with palm tree shadows in golden hour sunlight, relaxed summer vacation fashion aesthetic, cinematic photography.' },
  /* ── TRADITIONAL (10) — thumb-50 to thumb-59 ── */
  { id: 'nikah-portrait',      category: 'Traditional', name: 'Nikah Ceremony Portrait',         thumb: '/templates/thumb-50.jpg', prompt: 'Vertical 9:16 portrait photo, a graceful young woman wearing a delicate ivory and gold embroidered traditional gown with a matching sheer chiffon head covering, soft glowing indoor lighting with traditional lanterns, serene expression, high-end cultural wedding photography, 8k.' },
  { id: 'palace-lehenga',      category: 'Traditional', name: 'Palace Heritage Lehenga Look',    thumb: '/templates/thumb-51.jpg', prompt: 'Vertical 9:16 portrait photo, a stunning bride in a rich crimson and gold embroidered lehenga paired with traditional heavy gold jewelry, background of a grand heritage marble palace corridor with warm ambient lighting, cinematic portrait, 8k resolution.' },
  { id: 'velvet-groom',        category: 'Traditional', name: 'Royal Velvet Groom Attire',       thumb: '/templates/thumb-52.jpg', prompt: 'Vertical 9:16 portrait photo, a handsome groom wearing a deep maroon velvet sherwani intricately detailed with subtle gold threadwork and a regal turban, seated in a luxurious vintage royal lounge, warm dramatic lighting, cinematic portrait.' },
  { id: 'kurta-jacket',        category: 'Traditional', name: 'Festive Embroidered Kurta Jacket',thumb: '/templates/thumb-53.jpg', prompt: 'Vertical 9:16 portrait photo, a young man wearing a rich navy blue silk kurta paired with an ornate brocade nehru jacket, festive celebration background with warm string lights and traditional decor, elegant and sharp portrait styling.' },
  { id: 'regal-bride',         category: 'Traditional', name: 'Classic Regal Bride',             thumb: '/templates/thumb-54.jpg', prompt: 'Vertical 9:16 portrait photo, an elegant bride wearing a heavily embellished traditional red and gold heirloom ensemble, ornate maang tikka and bridal necklace, soft glowing candlelit heritage hall backdrop, rich textures, photorealistic.' },
  { id: 'festive-wear',        category: 'Traditional', name: 'Vibrant Cultural Festive Wear',   thumb: '/templates/thumb-55.jpg', prompt: 'Vertical 9:16 portrait photo, a smiling young woman wearing a vibrant multi-colored embroidered traditional tunic featuring intricate mirror work, bright marigold floral decorations in the blurred background, joyful celebratory atmosphere, vivid colors.' },
  { id: 'celebration-groom',   category: 'Traditional', name: 'Classic Celebration Groom',       thumb: '/templates/thumb-56.jpg', prompt: 'Vertical 9:16 portrait photo, a distinguished groom in a tailored cream-colored raw silk sherwani with delicate tonal embroidery, standing in a softly lit heritage architectural courtyard, sophisticated traditional menswear portrait.' },
  { id: 'henna-portrait',      category: 'Traditional', name: 'Henna Celebration Portrait',      thumb: '/templates/thumb-57.jpg', prompt: 'Vertical 9:16 portrait photo, a radiant young woman smiling softly while showing intricate henna patterns on her hands, wearing a pastel pink festive outfit adorned with floral jewelry, warm candlelit evening ambience, soft cinematic focus.' },
  { id: 'haldi-ceremony',      category: 'Traditional', name: 'Haldi Ceremony Glow',             thumb: '/templates/thumb-58.jpg', prompt: 'Vertical 9:16 portrait photo, a glowing young woman during a traditional pre-wedding yellow floral ceremony, wearing a simple bright yellow traditional attire with fresh jasmine flower garlands in her hair, warm sunny lighting, joyful and authentic vibe.' },
  { id: 'heritage-silk-drape', category: 'Traditional', name: 'Heritage Silk Drape Look',        thumb: '/templates/thumb-59.jpg', prompt: 'Vertical 9:16 portrait photo, a graceful woman wearing an opulent traditional silk saree with a rich gold zari woven border, traditional temple gold jewelry set, warm indoor lighting against a carved wooden backdrop, elegant heritage portrait.' },
  /* ── TRAVEL (10) — thumb-60 to thumb-69 ── */
  { id: 'dubai-skyline',       category: 'Travel',      name: 'Dubai Skyline Luxury',            thumb: '/templates/thumb-60.jpg', prompt: 'Vertical 9:16 portrait photo, a sophisticated man standing on a high-rise glass balcony overlooking the modern Dubai downtown skyscraper skyline at sunset, warm golden hour glow reflecting off glass towers, elegant casual polo shirt, cinematic travel photography, 8k.' },
  { id: 'santorini-escape',    category: 'Travel',      name: 'Santorini Island Escape',         thumb: '/templates/thumb-61.jpg', prompt: 'Vertical 9:16 portrait photo, a graceful woman in a flowing white summer dress posing against iconic whitewashed walls and blue-domed churches overlooking the Aegean sea, bright Mediterranean sunlight, dreamy travel aesthetic, photorealistic.' },
  { id: 'paris-twilight',      category: 'Travel',      name: 'Parisian Street Twilight',        thumb: '/templates/thumb-62.jpg', prompt: 'Vertical 9:16 portrait photo, an elegant woman wearing a chic beige trench coat strolling down a historic cobblestone Parisian street at dusk, the illuminated Eiffel Tower softly glowing in the blurred background, warm street lamps, cinematic mood.' },
  { id: 'maldives-bungalow',   category: 'Travel',      name: 'Maldives Overwater Bungalow',     thumb: '/templates/thumb-63.jpg', prompt: 'Vertical 9:16 portrait photo, a stylish man in a crisp white linen shirt and sunglasses standing on the wooden deck of a luxury tropical overwater villa, crystal clear turquoise ocean water and palm trees in the background, bright sunny vacation vibe.' },
  { id: 'tropical-palm-beach', category: 'Travel',      name: 'Tropical Palm Beach',             thumb: '/templates/thumb-64.jpg', prompt: 'Vertical 9:16 portrait photo, a radiant woman relaxing on a sun-drenched tropical sandy beach under leaning palm trees, wearing lightweight cream resort wear, soft golden hour sunlight breaking through, serene beach vacation atmosphere.' },
  { id: 'sunset-sand-dunes',   category: 'Travel',      name: 'Golden Sunset Sand Dunes',        thumb: '/templates/thumb-65.jpg', prompt: 'Vertical 9:16 portrait photo, a traveler resting on the ridge of a vast sweeping desert sand dune during a dramatic golden sunset, warm amber light casting long shadows across rippled golden sand, adventurous travel photography.' },
  { id: 'swiss-alpine',        category: 'Travel',      name: 'Swiss Alpine Peak Vista',         thumb: '/templates/thumb-66.jpg', prompt: 'Vertical 9:16 portrait photo, a man in a dark winter wool coat and scarf standing against a breathtaking backdrop of snowy Swiss alpine mountain peaks and dramatic clouds, crisp cool winter daylight, cinematic travel portrait.' },
  { id: 'misty-mountain',      category: 'Travel',      name: 'Mist-Covered Mountain Valley',    thumb: '/templates/thumb-67.jpg', prompt: 'Vertical 9:16 portrait photo, a person looking out over a lush green mountain valley shrouded in atmospheric morning mist and rolling hills, wearing an earth-toned cozy jacket, serene and peaceful travel mood, cinematic nature photography.' },
  { id: 'nyc-urban',           category: 'Travel',      name: 'New York City Urban Vibe',        thumb: '/templates/thumb-68.jpg', prompt: 'Vertical 9:16 portrait photo, a young man in a smart coat standing on a busy New York City street, classic red-brick urban architecture and iconic yellow cabs blurred in the background, moody overcast daylight, metropolitan travel aesthetic.' },
  { id: 'highland-retreat',    category: 'Travel',      name: 'Highland Hill Station Retreat',   thumb: '/templates/thumb-69.jpg', prompt: 'Vertical 9:16 portrait photo, a woman standing on a lush green mountain terrace overlooking rolling misty hills and pine forests, wearing a warm woolen shawl, calm and refreshing highland holiday atmosphere, high-definition travel shot.' },
  /* ── PRODUCTS (10) — thumb-70 to thumb-78, 80th reuses thumb-70 ── */
  { id: 'skincare-ritual',     category: 'Products',    name: 'Skincare Ritual Set',             thumb: '/templates/thumb-70.jpg', prompt: 'Vertical 9:16 product photo, elegant white frosted glass serum bottles and jade roller arranged on a clean white surface with soft botanical shadows and green leaves, bright natural morning studio lighting, high-end cosmetic brand advertising photography, ultra-sharp detail.' },
  { id: 'festive-gift-box',    category: 'Products',    name: 'Festive Luxury Gift Box Scene',   thumb: '/templates/thumb-71.jpg', prompt: 'Vertical 9:16 product photo, a premium dark violet open gift box revealing artisanal sweets and luxury items, decorated with warm brass oil lamps and orange marigold flowers, soft warm ambient lighting, festive luxury product display.' },
  { id: 'dark-perfume-shot',   category: 'Products',    name: 'Dark Moody Perfume Shot',         thumb: '/templates/thumb-72.jpg', prompt: 'Vertical 9:16 product photo, a sleek black glass luxury perfume bottle resting on dark slate stone with wet water droplets, dramatic side lighting casting deep shadows, elegant silver accents, high-end luxury fragrance commercial shot.' },
  { id: 'marble-skincare',     category: 'Products',    name: 'Luxury Marble Skincare Flat Lay', thumb: '/templates/thumb-73.jpg', prompt: "Vertical 9:16 top-down flat lay product photo, a clear glass dropper bottle with gold cap resting on a white vein marble slab with white baby's breath flowers and soft dappled sunlight shadows, clean minimalist aesthetic." },
  { id: 'scented-candle',      category: 'Products',    name: 'Gifting Scented Candle Scene',    thumb: '/templates/thumb-74.jpg', prompt: 'Vertical 9:16 product photo, an unboxed luxury scented soy candle in a clear glass jar, nestled inside a matte black foil-stamped gift box with dried botanical accents, warm soft studio lighting, cozy premium lifestyle product photography.' },
  { id: 'beverage-splash',     category: 'Products',    name: 'Beverage Hero Splash',            thumb: '/templates/thumb-75.jpg', prompt: 'Vertical 9:16 commercial product photo, a tall glass of iced coffee latte with swirling milk splashes suspended in mid-air around the glass, dark moody backdrop, dramatic high-speed studio photography, condensation on glass, ultra-detailed.' },
