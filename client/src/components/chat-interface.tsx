        ...
        const renderFunctionBtn = (icon: React.ReactNode, label: string, onClick: () => void, activeStyle?: string, testId?: string) => {
          if (isCircle) {
            return (
              ...
              >
                <div className={`w-14 h-14 rounded-full flex items-center justify-center transition-all duration-300 group-hover:scale-[1.15] ${squareShadow} ${activeStyle || 'text-muted-foreground bg-white dark:bg-[#303030] hover:bg-gray-50 dark:hover:bg-[#353535]'}`}>
                  {icon}
                </div>
