...
const IMAGINE_PROMPTS_BY_STYLE: Record<string, {label: string; prompt: string; img: string}[]> = {
  ...
  "3D Render": [
    { label: "Neon Megacity",       prompt: "a futuristic neon-lit megacity at night with holographic billboards and flying cars",                 img: `https://image.pollinations.ai/prompt/${encodeURIComponent("photorealistic CGI render of a chrome metallic robot head close-up, subsurface skin scattering, Octane render, dramatic studio key light, dark background, 8K ultra HD")}?width=600&height=400&nologo=true&seed=73821&model=flux-realism` },
    { label: "Space Station",       prompt: "a sleek orbital space station with Earth glowing below, photorealistic CGI render",                   img: `https://image.pollinations.ai/prompt/${encodeURIComponent("photorealistic 3D render of sleek white orbital space station above glowing blue Earth, Blender Cycles ray tracing, HDRI studio lighting, sharp detail")}?width=600&height=400&nologo=true&seed=83124&model=flux-realism` },
    { label: "Crystal Geometry",    prompt: "intricate glowing crystalline geometric structures floating in deep space void, blender render",      img: `https://image.pollinations.ai/prompt/${encodeURIComponent("photorealistic 3D Blender render of glowing iridescent crystal polyhedra floating in dark void, volumetric light caustics, glass refraction, Cycles render")}?width=600&height=400&nologo=true&seed=91045&model=flux-realism` },
    { label: "Underwater Base",     prompt: "a futuristic underwater research base with bioluminescent sea life, cinematic CGI render",            img: `https://image.pollinations.ai/prompt/${encodeURIComponent("photorealistic CGI underwater futuristic glass dome base, glowing bioluminescent jellyfish surrounding, deep ocean caustic light rays, Unreal Engine 5")}?width=600&height=400&nologo=true&seed=62537&model=flux-realism` },
    { label: "Sci-Fi Corridor",     prompt: "a sleek sci-fi spaceship corridor with glowing panels and metallic reflections, unreal engine 5",    img: `https://image.pollinations.ai/prompt/${encodeURIComponent("photorealistic Unreal Engine 5 sci-fi spaceship corridor interior, polished brushed metal floor, glowing blue panel strip lights, lumen global illumination")}?width=600&height=400&nologo=true&seed=54319&model=flux-realism` },
    { label: "Dragon 3D",           prompt: "a photorealistic CGI dragon with detailed scales and glowing eyes in a dark volcanic landscape",      img: `https://image.pollinations.ai/prompt/${encodeURIComponent("photorealistic CGI render of a dragon with iridescent scaled skin, glowing amber eyes, volcanic lava background, Blender Cycles subsurface scattering, cinematic")}?width=600&height=400&nologo=true&seed=47892&model=flux-realism` },
  ],
  "Watercolor": [
  ...
  "Pixel Art": [
    { label: "Retro City Night",    prompt: "a colorful 16-bit pixel art city skyline at night with neon signs and 8-bit cars on the streets",    img: `https://image.pollinations.ai/prompt/${encodeURIComponent("8-bit NES pixel art style, bright red and yellow Mario style platformer game scene, large visible square pixels, blocky sprites, solid color background, retro video game screenshot")}?width=600&height=400&nologo=true&seed=11223&model=flux` },
    { label: "Space Shooter",       prompt: "a retro 8-bit pixel art space shooter game with starfields, enemy ships, and laser beams",           img: `https://image.pollinations.ai/prompt/${encodeURIComponent("retro pixel art 8-bit space invaders style game, blocky alien sprites, bright green laser beams, black space background, large chunky pixels, NES game screenshot look")}?width=600&height=400&nologo=true&seed=22334&model=flux` },
    { label: "Dungeon Quest",       prompt: "a moody pixel art dungeon with flickering torches, treasure chests, and a pixelated hero",           img: `https://image.pollinations.ai/prompt/${encodeURIComponent("16-bit SNES Zelda style pixel art dungeon RPG, top down view, bright pixel torches, treasure chests, stone tile floor, chunky sprite hero, vibrant pixel colors")}?width=600&height=400&nologo=true&seed=33445&model=flux` },
    { label: "Mushroom Village",    prompt: "a cozy pixel art forest village with colorful mushroom houses and tiny fairy lights at dusk",         img: `https://image.pollinations.ai/prompt/${encodeURIComponent("16-bit SNES pixel art cozy village scene, bright red mushroom houses, large visible pixel squares, green pixel grass, blue sky, flat bright cartoon pixel game art")}?width=600&height=400&nologo=true&seed=44556&model=flux` },
    { label: "Island Adventure",    prompt: "a tiny pixel art tropical island with palm trees, buried treasure, and a pirate ship offshore",       img: `https://image.pollinations.ai/prompt/${encodeURIComponent("bright pixel art 16-bit tropical island, chunky pixel palm trees, blue pixel ocean waves, pixel pirate ship, retro game art style large visible pixels")}?width=600&height=400&nologo=true&seed=55667&model=flux` },
    { label: "Dragon Castle",       prompt: "a 16-bit pixel art dragon perched on a towering castle with a stormy pixelated sky",                 img: `https://image.pollinations.ai/prompt/${encodeURIComponent("16-bit SNES pixel art medieval castle, pixel dragon sprite on battlements, orange pixel fire breath, blocky stone walls, retro RPG game screenshot look, chunky pixels")}?width=600&height=400&nologo=true&seed=66778&model=flux` },
  ],
  "Sketch": [
