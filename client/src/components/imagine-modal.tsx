...
const CAT_STYLE: Record<string, { bg: string; accent: string }> = {
  organic:     { bg: 'linear-gradient(155deg,#0d2318 0%,#1e4d30 40%,#2e7a4a 70%,#4caa68 100%)', accent: '#6fcf8a' },
...
const VISUAL_TEMPLATES = [
  /* ── ORGANIC LIVING (10) ── */
  { id: 'pottery-studio',     category: 'organic',     emoji: '🏺', thumb: '/templates/thumb-0.jpg',  name: 'Pottery Studio',           prompt: 'close-up of hands crafting pottery on a wheel, warm sunlight streaming through a window, ceramic pieces on wooden shelves in background, artisan workshop, craftsman vibe, natural earthy tones, cinematic photography' },
  { id: 'japandi-bath',       category: 'organic',     emoji: '🛁', thumb: '/templates/thumb-1.jpg',  name: 'Japandi Sanctuary',        prompt: 'minimalist Japandi bathroom, freestanding stone bathtub, bamboo flooring, living green wall with plants, soft diffused natural light, luxury spa vibe, peaceful minimalism, architectural photography' },
  { id: 'foraged-kitchen',    category: 'organic',     emoji: '🌿', thumb: '/templates/thumb-2.jpg',  name: 'Foraged Kitchen',          prompt: 'rustic wooden kitchen shelves with hanging dried herbs and lavender bundles, hand-carved wooden utensils, ambient green backlighting, warm earthy tones, farm-to-table aesthetic, editorial food photography' },
  { id: 'terracotta-oasis',   category: 'organic',     emoji: '🪴', thumb: '/templates/thumb-3.jpg',  name: 'Terracotta Oasis',         prompt: 'cozy urban corner filled with terracotta pots of varying sizes, exotic large-leaf tropical indoor plants, warm afternoon light, boho urban jungle vibe, interior lifestyle photography' },
  { id: 'textile-loom',       category: 'organic',     emoji: '🧶', thumb: '/templates/thumb-4.jpg',  name: 'Textile Loom',             prompt: 'handmade woolen rug on a traditional wooden loom, raw cotton bundles and hand-dyed colorful yarns scattered nearby, earthy fiber textures, artisan textile craft, warm natural light, editorial lifestyle photography' },
  { id: 'desert-bloom',       category: 'organic',     emoji: '🌵', thumb: '/templates/thumb-5.jpg',  name: 'Desert Bloom',             prompt: 'resilient succulent and cactus plants growing from arid desert earth, mud-brick dwelling in the background, golden hour desert light, minimalist desert aesthetic, National Geographic quality photography' },
  { id: 'basket-market',      category: 'organic',     emoji: '🧺', thumb: '/templates/thumb-6.jpg',  name: 'Basketry Market',          prompt: 'artistic boho display of natural fiber baskets, rattan mats, jute and bamboo woven wares, earthy neutral tones, warm market light, bohemian lifestyle photography' },
  { id: 'root-cellar',        category: 'organic',     emoji: '🥕', thumb: '/templates/thumb-7.jpg',  name: 'Root Cellar Harvest',      prompt: 'fresh root vegetables, carrots, potatoes and farm produce resting in an old stone cellar, rustic earthy tones, ambient damp cellar light, farm-to-table editorial photography' },
  { id: 'geode-collection',   category: 'organic',     emoji: '💎', thumb: '/templates/thumb-8.jpg',  name: 'Geode Collection',         prompt: 'curated collection of raw geological crystals, sparkling geodes and natural gemstones on a wooden surface, macro detail photography, earthy mineral textures, geological lifestyle photography' },
  { id: 'monsoon-window',     category: 'organic',     emoji: '🌧️', thumb: '/templates/thumb-9.jpg',  name: 'Monsoon Mood',             prompt: 'cozy rain-streaked window pane looking out at lush green forest, steaming mug of coffee on wooden windowsill, warm glowing candle, soft knit blanket, moody monsoon atmospheric lighting, cinematic photography' },

  /* ── PORTRAITS (10) ── */
  { id: 'artisan-portrait',   category: 'portrait',    emoji: '🪡', thumb: '/templates/thumb-10.jpg', name: 'The Artisan',              prompt: 'candid warm portrait of a leatherworker in a cluttered artisan workshop, focused on stitching, rich leather textures and tools visible, natural workshop lighting, authentic documentary portrait photography' },
  { id: 'ballet-portrait',    category: 'portrait',    emoji: '🩰', thumb: '/templates/thumb-11.jpg', name: 'Ballet Dancer',            prompt: 'dramatic low-key portrait of a ballerina in a dance studio looking into a mirror, tension and grace before performance, chiaroscuro theatrical lighting, emotional dance portrait photography' },
  { id: 'aviator-portrait',   category: 'portrait',    emoji: '✈️', thumb: '/templates/thumb-12.jpg', name: 'Vintage Aviator',          prompt: 'sepia-toned portrait of a 1930s pilot in a worn leather jacket and goggles, vintage biplane background, warm amber tones, historical evocative portrait, analog film grain texture' },
  { id: 'cyberpunk-portrait', category: 'portrait',    emoji: '🥽', thumb: '/templates/thumb-13.jpg', name: 'Cyberpunk Hacker',         prompt: 'neon-lit portrait of a young person with reflective cyberpunk glasses and subtle tech implants, rainy futuristic urban alley background, electric blues and magentas, sci-fi moody atmosphere' },
  { id: 'elder-portrait',     category: 'portrait',    emoji: '🧿', thumb: '/templates/thumb-14.jpg', name: 'Tribal Elder',             prompt: 'dignified portrait of a wise tribal elder with intricate traditional jewelry, weathered expressive features, deep wise gaze, natural window lighting, cultural respectful portrait photography' },
  { id: 'editorial-portrait', category: 'portrait',    emoji: '💄', thumb: '/templates/thumb-15.jpg', name: 'Fashion Editorialist',     prompt: 'bold high-fashion editorial portrait, avant-garde makeup and clothing, strong geometric color blocks, minimalist set design, Vogue magazine quality editorial photography' },
  { id: 'jazz-portrait',      category: 'portrait',    emoji: '🎷', thumb: '/templates/thumb-16.jpg', name: 'Jazz Musician',            prompt: 'smoky atmospheric portrait of a saxophonist in a jazz club, bathed in warm golden spotlight, saxophone gleaming, ambient club smoke, classic moody jazz photography' },
  { id: 'explorer-portrait',  category: 'portrait',    emoji: '🧭', thumb: '/templates/thumb-17.jpg', name: 'Victorian Explorer',       prompt: 'studio portrait of a Victorian explorer in a tweed suit and pith helmet, holding an antique compass, adventurous gaze off-camera, warm studio lighting, costumed thematic portrait photography' },
  { id: 'polymath-portrait',  category: 'portrait',    emoji: '📚', thumb: '/templates/thumb-18.jpg', name: 'Modern Polymath',          prompt: 'split dramatic lighting portrait of a person, one side surrounded by stacked books and spectacles, other side holding a paintbrush, conceptual dual-nature portrait, cinematic editorial photography' },
  { id: 'runner-portrait',    category: 'portrait',    emoji: '🏃', thumb: '/templates/thumb-19.jpg', name: 'Marathon Runner',          prompt: 'sweaty post-race portrait of a marathon athlete, face showing raw exhaustion and triumph, emotion-filled authentic moment, dramatic natural light, sports portrait photography' },

  /* ── FANTASY (10) ── */
  { id: 'elven-spy',          category: 'fantasy',     emoji: '🧝', thumb: '/templates/thumb-20.jpg', name: 'Elven Spymaster',          prompt: 'sharp low-key fantasy portrait of a high elf in dark intricate leather armor and hooded cloak, subtle scars and one piercing golden eye, holding a coded message, stealth intellect fantasy art, digital painting' },
  { id: 'gnome-artificer',    category: 'fantasy',     emoji: '⚙️', thumb: '/templates/thumb-21.jpg', name: 'Gnomish Artificer',        prompt: 'cheerful older gnome with wild white hair and goggles pushed on forehead, grease-stained vest, tinkering with a small glowing magical automaton, steampunk cheerful fantasy portrait, digital art' },
  { id: 'undead-lich',        category: 'fantasy',     emoji: '💀', thumb: '/templates/thumb-22.jpg', name: 'The Undead Lich',          prompt: 'dramatic high-contrast portrait of an ancient skeletal sorcerer lich, tattered robes, empty eye sockets burning with cold blue fire, one hand raised crackling with dark necromantic magic, horror fantasy digital art' },
  { id: 'celestial-paladin',  category: 'fantasy',     emoji: '⚔️', thumb: '/templates/thumb-23.jpg', name: 'Celestial Paladin',        prompt: 'heroic fantasy portrait of a human warrior in polished gilded armor adorned with sun and celestial motifs, radiant holy glow, determined expression, leaning on a massive two-handed sword, lawful good cinematic fantasy art' },
  { id: 'shapeshifter-druid', category: 'fantasy',     emoji: '🐻', thumb: '/templates/thumb-24.jpg', name: 'Shapeshifter Druid',       prompt: 'striking semi-feral portrait of a female druid in earthy mossy armor, glowing green eyes, one arm visibly transforming into a bear claw, nature magic wild transformation, detailed fantasy digital painting' },
  { id: 'shadow-sorcerer',    category: 'fantasy',     emoji: '🌑', thumb: '/templates/thumb-25.jpg', name: 'Shadow Sorcerer',          prompt: 'brooding low-key portrait of a young sorcerer surrounded by swirling inky black shadows, face obscured, eyes glowing with intense purple arcane power, moody chaos magic fantasy art, dramatic lighting' },
  { id: 'centaur-huntress',   category: 'fantasy',     emoji: '🏹', thumb: '/templates/thumb-26.jpg', name: 'Centaur Huntress',         prompt: 'powerful dynamic portrait of a centaur archer in practical travel-worn armor, intense gaze while nocking an arrow, vast windswept plains in background, action fantasy digital painting, epic scale' },
  { id: 'vampire-lord',       category: 'fantasy',     emoji: '🧛', thumb: '/templates/thumb-27.jpg', name: 'Vampire Lord',             prompt: 'opulent classic portrait of a vampire aristocrat in rich velvet and antique lace, enigmatic pale expression, single drop of blood on lip, candlelit historical mansion interior, dark romance fantasy art' },
  { id: 'dragonborn-barb',    category: 'fantasy',     emoji: '🐉', thumb: '/templates/thumb-28.jpg', name: 'Dragonborn Barbarian',     prompt: 'fierce detailed portrait of a red-scaled dragonborn warrior with curved horns and broken warhammer, roaring with fury, steam rising from scales, raw intense fantasy digital art, dramatic fiery background' },
  { id: 'kitsune-illusionist',category: 'fantasy',     emoji: '🦊', thumb: '/templates/thumb-29.jpg', name: 'Kitsune Illusionist',      prompt: 'vibrant playful portrait of a kitsune fox spirit in traditional stylized Japanese robes, multiple shimmering magical tails, holding a glowing illusionary orb, anime-esque cultural fantasy art, vivid colors' },

  /* ── FASHION (10) ── */
  { id: 'monochrome-fashion',  category: 'fashion',    emoji: '🤍', thumb: '/templates/thumb-30.jpg', name: 'Monochrome Minimalist',    prompt: 'sleek high-fashion editorial portrait of a model in head-to-toe crisp cream tailoring, stark architectural concrete wall backdrop, clean geometric lines, high-fashion minimalist photography, Vogue quality' },
  { id: 'boho-resort',         category: 'fashion',    emoji: '🌺', thumb: '/templates/thumb-31.jpg', name: 'Bohemian Resort',          prompt: 'breezy sun-dappled fashion shot of a model in flowing linen separates and wide-brim straw hat, Mediterranean pergola with climbing vines, golden hour resort lifestyle photography, relaxed boho chic' },
  { id: 'cyber-goth',          category: 'fashion',    emoji: '🖤', thumb: '/templates/thumb-32.jpg', name: 'Edgy Cyber-Goth',          prompt: 'moody neon-accented fashion portrait with structural black faux-leather apparel, silver hardware and chains, dramatic split neon lighting, alternative avant-garde fashion editorial photography' },
  { id: 'retro-70s',           category: 'fashion',    emoji: '📷', thumb: '/templates/thumb-33.jpg', name: 'Vintage Retro 70s',        prompt: 'warm nostalgic portrait of a model styled in a patterned turtleneck, corduroy blazer and amber tinted frames, vintage film grain, Kodachrome color palette, 1970s retro fashion photography' },
  { id: 'trench-heritage',     category: 'fashion',    emoji: '🧥', thumb: '/templates/thumb-34.jpg', name: 'Classic Trench',           prompt: 'sophisticated moody street-style portrait of a model wearing a classic double-breasted beige trench coat on a misty city morning, rain-slicked cobblestones, timeless outerwear fashion editorial' },
  { id: 'winter-layering',     category: 'fashion',    emoji: '🏔️', thumb: '/templates/thumb-35.jpg', name: 'Winter Layering',          prompt: 'cozy stylish mountain-chic fashion look, chunky cable-knit sweater under a quilted puffer vest, snowy alpine backdrop with pine trees, seasonal winter fashion lifestyle photography' },
  { id: 'velvet-renaissance',  category: 'fashion',    emoji: '💜', thumb: '/templates/thumb-36.jpg', name: 'Velvet Renaissance',       prompt: 'opulent rich-toned portrait of a model draped in a deep emerald velvet suit, antique dimly lit interior with oil paintings, candlelight glow, luxurious dramatic fashion editorial photography' },
  { id: 'denim-studio',        category: 'fashion',    emoji: '👖', thumb: '/templates/thumb-37.jpg', name: 'Denim-on-Denim',           prompt: 'cool modern editorial portrait featuring structured dark-wash denim jacket and jeans, minimalist grey studio backdrop, dramatic side lighting, casual edgy fashion photography' },
  { id: 'pastel-spring',       category: 'fashion',    emoji: '🌸', thumb: '/templates/thumb-38.jpg', name: 'Pastel Spring',            prompt: 'soft glowing outdoor portrait of a model in a light lavender pastel structured suit, surrounded by blooming cherry blossoms and spring flowers, bright fresh fashion editorial photography' },
  { id: 'techwear-future',     category: 'fashion',    emoji: '🤖', thumb: '/templates/thumb-39.jpg', name: 'Futuristic Techwear',      prompt: 'dynamic high-utility futuristic techwear fashion look, multi-pocket cargo straps and matte black technical fabrics, industrial warehouse lighting, modern functional fashion editorial photography' },

  /* ── TRADITIONAL (10) ── */
  { id: 'royal-sherwani',     category: 'traditional', emoji: '👑', thumb: '/templates/thumb-40.jpg', name: 'Royal Sherwani',           prompt: 'regal portrait of a groom in heavy embroidered velvet sherwani with traditional kalgi and ornate safa turban, antique royal palace jharokha arch background, warm golden lighting, cinematic wedding photography' },
  { id: 'saree-elegance',     category: 'traditional', emoji: '🪷', thumb: '/templates/thumb-41.jpg', name: 'Ethereal Saree',           prompt: 'soft golden-hour portrait of a woman in a handloom organza saree with minimal kundan jewellery, standing in a heritage sandstone courtyard, warm afternoon light, elegant traditional fashion photography' },
  { id: 'qawwali-night',      category: 'traditional', emoji: '🎵', thumb: '/templates/thumb-42.jpg', name: 'Qawwali Night',            prompt: 'moody warm-lit portrait of a qawwali musician in traditional kurta-pajama with a fine shawl, sitting with harmonium or tabla, amber candlelight and diyas, atmospheric Sufi music photography' },
  { id: 'shalwar-classic',    category: 'traditional', emoji: '🏛️', thumb: '/templates/thumb-43.jpg', name: 'Shalwar Kameez',           prompt: 'rugged sophisticated portrait of a man in crisp white shalwar kameez with a fine leather waistcoat, textured brick wall background, dramatic natural light, South Asian traditional fashion editorial' },
  { id: 'bandhgala-festive',  category: 'traditional', emoji: '🪔', thumb: '/templates/thumb-44.jpg', name: 'Festive Bandhgala',        prompt: 'sharp modern-traditional portrait of a model in a dark jewel-toned bandhgala suit, surrounded by Diwali or Eid festive string lights and bokeh, warm celebratory editorial photography' },
  { id: 'bridal-zardosi',     category: 'traditional', emoji: '👰', thumb: '/templates/thumb-45.jpg', name: 'Bridal Zardosi',           prompt: 'cinematic close-up portrait of a South Asian bride in heavy zardosi embroidered lehenga with traditional matha patti headpiece, shy downward gaze, warm golden backlight, luxury bridal photography' },
  { id: 'sufi-whirling',      category: 'traditional', emoji: '🌀', thumb: '/templates/thumb-46.jpg', name: 'Sufi Whirling',            prompt: 'dynamic atmospheric shot of a Sufi whirling dervish dancer in flowing white traditional attire, motion blur capturing the spin, deep blue and indigo atmospheric lighting, spiritual dance photography' },
  { id: 'phulkari-punjabi',   category: 'traditional', emoji: '🌻', thumb: '/templates/thumb-47.jpg', name: 'Phulkari & Kurta',         prompt: 'vibrant outdoor rural-chic portrait featuring bright Phulkari embroidery dupatta and traditional Punjabi kurta, golden field backdrop, rich cultural embroidery textures, joyful lifestyle photography' },
  { id: 'mughal-miniature',   category: 'traditional', emoji: '🏯', thumb: '/templates/thumb-48.jpg', name: 'Mughal Miniature',         prompt: 'art-inspired portrait with lighting and composition inspired by Mughal miniature paintings, ornate royal staging, fine jewellery and brocade fabrics, rich jewel-toned palette, heritage art photography' },
  { id: 'indo-western',       category: 'traditional', emoji: '✨', thumb: '/templates/thumb-49.jpg', name: 'Indo-Western Fusion',      prompt: 'contemporary ethnic fashion look with an asymmetrical kurta combined with a structured blazer jacket, modern studio lighting, clean editorial background, fusion fashion shoot, South Asian contemporary style' },

  /* ── TRAVEL (10) ── */
  { id: 'dubai-luxury',       category: 'travel',      emoji: '🏙️', thumb: '/templates/thumb-50.jpg', name: 'Dubai Skyline',            prompt: 'sleek travel portrait of a person on a luxury glass balcony or rooftop, Burj Khalifa towering in background, golden hour sunset glow over Dubai skyline, aspirational luxury travel photography' },
  { id: 'paris-elegance',     category: 'travel',      emoji: '🗼', thumb: '/templates/thumb-51.jpg', name: 'Parisian Elegance',        prompt: 'cinematic travel shot with classic Haussmann buildings and a misty morning view of the Eiffel Tower, model wearing a chic beige trench coat, cobblestone street, romantic Paris editorial travel photography' },
  { id: 'hill-station-mist',  category: 'travel',      emoji: '🌫️', thumb: '/templates/thumb-52.jpg', name: 'Misty Hill Station',       prompt: 'atmospheric travel portrait of a person in a woollen scarf and coat standing in a misty green hill station, rolling fog over lush mountains, cozy monsoon mountain travel photography' },
  { id: 'santorini-dream',    category: 'travel',      emoji: '🏛️', thumb: '/templates/thumb-53.jpg', name: 'Santorini Dream',          prompt: 'sunny Santorini travel shot with iconic whitewashed architecture and blue-domed churches, sparkling Aegean Sea background, vibrant Mediterranean light, editorial travel photography' },
  { id: 'kyoto-bamboo',       category: 'travel',      emoji: '🎋', thumb: '/templates/thumb-54.jpg', name: 'Kyoto Bamboo',             prompt: 'peaceful travel portrait in Arashiyama bamboo grove Kyoto, tall green bamboo stalks filtering soft dappled light, traditional stone pathway, serene Japanese travel photography' },
  { id: 'swiss-alps',         category: 'travel',      emoji: '⛷️', thumb: '/templates/thumb-55.jpg', name: 'Swiss Alps Peak',          prompt: 'winter adventure travel aesthetic, snow-capped Swiss Alps mountain peaks, pine trees blanketed in fresh snow, person in cozy winter gear, crisp clean alpine photography' },
  { id: 'amalfi-terrace',     category: 'travel',      emoji: '🍋', thumb: '/templates/thumb-56.jpg', name: 'Amalfi Terrace',           prompt: 'Mediterranean travel vibe with colorful cliffside Amalfi Coast houses, deep azure sea, lemon grove terrace, golden afternoon light, dreamy Italian coastal travel photography' },
  { id: 'venice-canal',       category: 'travel',      emoji: '🚣', thumb: '/templates/thumb-57.jpg', name: 'Venice Canal',             prompt: 'atmospheric evening travel shot in Venice, gondola gliding past a historic arched bridge, warm glowing lanterns reflecting on water, moody romantic travel photography' },
  { id: 'kyoto-autumn',       category: 'travel',      emoji: '🍁', thumb: '/templates/thumb-58.jpg', name: 'Kyoto Autumn',             prompt: 'vibrant Japanese Koyo autumn travel shot, brilliant red and orange maple leaves surrounding a traditional wooden temple, warm autumn light, cultural travel photography' },
  { id: 'iceland-black-sand', category: 'travel',      emoji: '🌋', thumb: '/templates/thumb-59.jpg', name: 'Iceland Black Sand',       prompt: 'dramatic moody Iceland landscape, black volcanic sand beach with massive basalt rock columns, dark brooding ocean waves, cinematic wide travel photography, powerful natural drama' },

  /* ── PRODUCTS (10) ── */
  { id: 'skincare-flatlay',   category: 'products',    emoji: '🌿', thumb: '/templates/thumb-60.jpg', name: 'Botanical Skincare',       prompt: 'clean minimalist skincare product flatlay on white marble surface, organic glass bottles with botanical labels, fresh green eucalyptus leaves, jade facial roller, soft natural morning light, professional product photography' },
  { id: 'diya-mithai',        category: 'products',    emoji: '🪔', thumb: '/templates/thumb-61.jpg', name: 'Festive Mithai & Diya',    prompt: 'luxury Indian festival product shot, ornate sweet mithai box on rich velvet fabric with marigold flowers, glowing clay diyas arranged around, warm golden festive glow, editorial product photography' },
  { id: 'iced-coffee-splash', category: 'products',    emoji: '☕', thumb: '/templates/thumb-62.jpg', name: 'Iced Coffee Splash',       prompt: 'dynamic beverage product shot of a tall iced latte in a glass with swirling milk and coffee, dramatic milk splash droplets frozen in motion, dark background, high-speed commercial beverage photography' },
  { id: 'dark-perfume',       category: 'products',    emoji: '🖤', thumb: '/templates/thumb-63.jpg', name: 'Dark Luxury Perfume',      prompt: 'sleek moody luxury perfume bottle on dark textured volcanic stones, subtle golden rim light from behind creating dramatic halo, deep shadow, high-end commercial fragrance product photography' },
  { id: 'coffee-beans',       category: 'products',    emoji: '☕', thumb: '/templates/thumb-64.jpg', name: 'Artisan Coffee Beans',     prompt: 'dark rustic wooden table with freshly roasted coffee beans artfully spilled, antique brass coffee grinder, steaming espresso cup, rich earthy brown tones, moody artisan coffee product photography' },
  { id: 'luxury-watch',       category: 'products',    emoji: '⌚', thumb: '/templates/thumb-65.jpg', name: 'Luxury Watch',             prompt: 'matte black surface product shot of a sleek executive luxury watch, folded premium leather wallet, and fountain pen, sharp geometric shadows, professional minimalist corporate product photography' },
  { id: 'honey-jar',          category: 'products',    emoji: '🍯', thumb: '/templates/thumb-66.jpg', name: 'Organic Honey',            prompt: 'golden-hued honey product shot of a glass honey jar with honey dripping from a wooden honeycomb dipper, fresh wildflowers arranged nearby, warm glowing sunlight, natural organic lifestyle product photography' },
  { id: 'clay-mask',          category: 'products',    emoji: '🧴', thumb: '/templates/thumb-67.jpg', name: 'Clay Mask Spa',            prompt: 'spa aesthetic product shot of earthy green clay mask in a ceramic bowl, wooden application brush, fresh eucalyptus branch, white marble surface, clean natural beauty product photography' },
  { id: 'tech-gadget',        category: 'products',    emoji: '🎧', thumb: '/templates/thumb-68.jpg', name: 'Tech Gadget',              prompt: 'pastel matte studio backdrop product shot of sleek wireless headphones, clean geometric cast shadows, minimal composition, modern tech lifestyle product photography, soft studio lighting' },
  { id: 'citrus-splash',      category: 'products',    emoji: '🍊', thumb: '/templates/thumb-69.jpg', name: 'Citrus Refreshment',       prompt: 'bright vibrant summer beverage product shot with citrus juice glass surrounded by sliced fresh oranges and lemons, dramatic water splash droplets in motion, high-speed commercial photography, vivid colors' },

  /* ── NATURE (10) ── */
  { id: 'golden-mountain',    category: 'nature',      emoji: '⛰️', thumb: '/templates/thumb-70.jpg', name: 'Golden Hour Peak',         prompt: 'breathtaking golden hour mountain peak landscape, warm amber and orange light painting the snow-capped summits, dramatic cloud formations, National Geographic quality nature photography' },
  { id: 'misty-waterfall',    category: 'nature',      emoji: '💧', thumb: '/templates/thumb-71.jpg', name: 'Misty Waterfall',          prompt: 'magical misty waterfall cascading through a lush tropical forest, soft diffused green light filtering through dense canopy, moss-covered rocks, serene nature photography' },
  { id: 'desert-dunes',       category: 'nature',      emoji: '🏜️', thumb: '/templates/thumb-72.jpg', name: 'Desert Dunes Sunrise',     prompt: 'sweeping golden sand dunes at sunrise, long shadows creating dramatic wave-like patterns, vast silence and minimalism, Sahara or Arabian desert, cinematic nature landscape photography' },
  { id: 'tropical-ocean',     category: 'nature',      emoji: '🌊', thumb: '/templates/thumb-73.jpg', name: 'Tropical Ocean Wave',      prompt: 'stunning turquoise tropical ocean wave crashing, crystal clear water revealing sandy seafloor, vibrant blue and teal tones, paradise beach, National Geographic ocean photography' },
  { id: 'cherry-blossom',     category: 'nature',      emoji: '🌸', thumb: '/templates/thumb-74.jpg', name: 'Cherry Blossom Path',      prompt: 'dreamy sakura cherry blossom tunnel path in Japan, pink petals falling gently, soft pastel pink light, romantic spring atmosphere, Japanese nature travel photography' },
  { id: 'aurora-borealis',    category: 'nature',      emoji: '🌌', thumb: '/templates/thumb-75.jpg', name: 'Aurora Borealis',          prompt: 'spectacular northern lights aurora borealis dancing across a dark Arctic sky, vivid green and purple ribbons of light, starry sky reflection on a still lake, Iceland night nature photography' },
  { id: 'autumn-forest',      category: 'nature',      emoji: '🍂', thumb: '/templates/thumb-76.jpg', name: 'Autumn Forest Carpet',     prompt: 'golden autumn forest with a thick carpet of fallen red and orange maple leaves, tall trees creating a canopy of fire colors, misty morning light, peaceful fall nature photography' },
  { id: 'monsoon-jungle',     category: 'nature',      emoji: '🌧️', thumb: '/templates/thumb-77.jpg', name: 'Monsoon Jungle Rain',      prompt: 'lush monsoon tropical jungle during heavy rain, vibrant emerald green vegetation glistening with raindrops, dramatic rain curtain, moody atmospheric tropical nature photography' },
  { id: 'snow-pine-forest',   category: 'nature',      emoji: '❄️', thumb: '/templates/thumb-78.jpg', name: 'Snow Pine Forest',         prompt: 'magical snow-covered pine forest in winter, heavy white snow bending the branches, silent peaceful atmosphere, soft blue-white winter light, fairy tale winter nature photography' },
  { id: 'underwater-coral',   category: 'nature',      emoji: '🐠', thumb: '/templates/thumb-0.jpg',  name: 'Underwater Coral Reef',    prompt: 'stunning underwater coral reef ecosystem, vibrant tropical fish swimming through colorful coral formations, crystal clear blue water, sunlight rays piercing from above, marine nature photography' },
];
