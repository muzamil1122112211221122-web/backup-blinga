...
Tab content (Fius Games logos/leaderboard, Philosophers avatars) used to only start
...
data that needs to survive component unmount/remount (e.g. FiusGames leaderboard),
