...
export async function sendVerificationEmail(
  ...
  try {
    await transporter.sendMail({
      from: `"Blinga" <${cfg.from}>`,
      to: toEmail,
      subject: "Verify your Blinga account",
      html: `
        <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:40px 32px;background:#0d0d0d;color:#f4f4f5;border-radius:16px;">
          <div style="margin-bottom:28px;">
            <img src="${baseUrl}/blinga-logo.png" alt="Blinga" width="48" height="48" style="border-radius:12px;object-fit:contain;margin-bottom:20px;display:block;" />
            <h1 style="font-size:22px;font-weight:700;margin:0 0 8px;">Welcome to Blinga, ${name}!</h1>
          ...
          <p style="color:#71717a;font-size:13px;margin:0;">This link expires in 24 hours. If you didn't sign up for Blinga, you can safely ignore this email.</p>
        </div>
      `,
    });
